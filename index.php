...
$sig = "Powered by <a href='http://wondercms.com'>WonderCMS</a> and <a href='http://avocadocode.com'>AvocadoCode Studio</a>";
$hook['admin-richText'] = "rte.php";
echo("<!-- Implementation by Chomiciak> Karol Sobanski from AvocadoCode Studio -->");
...
function loadPlugins(){
	...
	chdir($cwd);
	$hook['admin-head'][] = "<script src='//cdn.tinymce.com/4/tinymce.min.js'></script> <script type='text/javascript' src='./js/editInplace.php?hook=".$hook['admin-richText']."'></script>";
}
...
ob_end_flush();
?>
<!-- Implementation by Chomiciak> Karol Sobanski from AvocadoCode Studio -->
